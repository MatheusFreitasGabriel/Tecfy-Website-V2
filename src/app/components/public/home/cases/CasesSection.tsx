    ...
    return (
        <section id={id} className="w-full flex flex-col items-center gap-6 lg:gap-12 scroll-mt-36">
            ...
            <div  className="flex flex-col gap-4 items-center px-4">
                <span className="text-[14px] text-secondary font-medium uppercase">Portfólio</span>
                <h2 className="leading-none text-[36px] text-text-primary text-center font-semibold sm:text-[48px] 2xl:text-[56px] uppercase">Nosso Trabalho</h2>
                <p className="text-center text-[14px] text-text-secondary sm:text-[14px] lg:text-[16px] xl:text-[16px] uppercase">
                    Veja o nosso trabalho e nossos casos de sucesso; <br className="hidden sm:block" />
                    inspire-se neles, pois eles são de qualidade Tecfy
                </p>
            </div>
