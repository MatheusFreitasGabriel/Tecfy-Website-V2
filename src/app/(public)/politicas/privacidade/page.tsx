...
// Tipos espelhados do seu código Angular
import { TERMS_DATA, ConteudoBlock } from './types';

const PoliticaPrivacidade = () => {
  const titleSection = "Política de Privacidade";
  const lastUpdateDate = "27 de Nov, 2025";

  // Função idêntica ao seu generateId do Angular
...
// Sub-componente que atua como o <ng-template #contentRenderer>
